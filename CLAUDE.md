# AI Assistant Guide for Fermata Development

**Version:** 2.0
**Last Updated:** 2025-12-31
**Purpose:** Comprehensive guidelines for AI assistants working with the Fermata Rust project

## About This Document

This document provides essential guidance for AI assistants (like Claude Code) when working with the Fermata codebase. It focuses on **Fermata-specific** conventions, patterns, and workflows, while deferring to authoritative Rust guidelines for general best practices.
...
**This document provides Fermata-specific guidance. For Rust best practices:**
...
2. **Fermata conventions** → Use this document
