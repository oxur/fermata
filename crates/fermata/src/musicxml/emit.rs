...
use crate::ir::common::{
    AccidentalValue, BackwardForward, RightLeftMiddle, StartStop, StartStopDiscontinue,
...
fn emit_note(w: &mut XmlWriter, note: &Note) -> Result<(), EmitError> {
    ...
    for _notations in &note.notations {
        // Notations emission would go here (Milestone 4)
    }
...
mod tests {
    ...
    use crate::ir::common::{Editorial, Position, StartStop, StartStopDiscontinue, YesNo};
    use crate::ir::duration::{Dot, NoteType, TimeModification};
    use crate::ir::note::{
        Accidental, FullNote, NoteContent, PitchRestUnpitched, Rest as NoteRest,
    };
